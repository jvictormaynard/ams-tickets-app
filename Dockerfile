...
RUN apk add --no-cache build-base python3 python3-dev py3-setuptools sqlite-dev vips-dev
...
# Copy .env.local file for environment variables
COPY code/.env.local .env.local
